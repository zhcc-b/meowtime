...
sealed class ClockFont(
    ...
    ) : ClockFont(name, sizeMultiplier, widthFitMultiplier) {
...
val AvailableClockFonts = listOf(
    ...
    ClockFont.Local("Digital", R.font.digital, sizeMultiplier = 1.72f, widthFitMultiplier = 0.88f),
    ClockFont.Local("Pixel", R.font.pixels, sizeMultiplier = 1.5f, widthFitMultiplier = 0.90f)
)
